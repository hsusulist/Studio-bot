...
LESSONS: List[dict] = [
    ...
    {
        "n": 1,
        "title": "print() và Output cơ bản",
        "phase": "Fundamentals",
        "keywords": ["print", "output", "console", "warn", "error", "debug"],
        "difficulty": "Beginner",
        "prerequisites": [],
        "learning_objectives": [
            "Hiểu print() là gì và tại sao quan trọng",
            "Sử dụng print() để debug code",
            "Phân biệt print(), warn(), error()",
            "In nhiều giá trị cùng lúc",
            "Sử dụng string formatting trong print",
        ],
        "subtopics": [
            {"name": "print() cơ bản", "description": "Cách dùng print() để hiển thị text", "examples": 2},
            {"name": "In biến", "description": "Cách in giá trị của biến", "examples": 2},
            {"name": "In nhiều giá trị", "description": "print(a, b, c) với dấu phẩy", "examples": 2},
            {"name": "warn() cho cảnh báo", "description": "Khi nào dùng warn()", "examples": 1},
            {"name": "error() cho lỗi", "description": "Khi nào dùng error()", "examples": 1},
            {"name": "Debug với print", "description": "Kỹ thuật debug cơ bản", "examples": 2},
        ],
        "common_mistakes": [
            "Quên dấu ngoặc: print 'hello' thay vì print('hello')",
            "Nhầm lẫn giữa print và return",
            "Không biết output hiện ở đâu trong Roblox Studio",
        ],
        "real_world": "Debug scripts, log player actions, test code",
        "estimated_time": "15-20 minutes",
        "mini_project": "Tạo script in ra thông tin player khi join game"
    },
    {
        "n": 2,
        "title": "Variables - Biến local và global",
        "phase": "Fundamentals",
        "keywords": ["local", "global", "variable", "scope", "assignment", "declare"],
        "difficulty": "Beginner",
        "prerequisites": [1],
        "learning_objectives": [
            "Hiểu biến là gì và tại sao cần dùng",
            "Khai báo biến local đúng cách",
            "Hiểu tại sao nên TRÁNH global variables",
            "Đặt tên biến theo convention",
            "Gán và thay đổi giá trị biến",
        ],
        "subtopics": [
            {"name": "Biến là gì?", "description": "Khái niệm container lưu trữ data", "examples": 2},
            {"name": "Khai báo local", "description": "local variableName = value", "examples": 3},
            {"name": "Global variables", "description": "Tại sao KHÔNG nên dùng", "examples": 2},
            {"name": "Naming conventions", "description": "camelCase, UPPER_CASE cho constants", "examples": 2},
            {"name": "Reassignment", "description": "Thay đổi giá trị biến", "examples": 2},
            {"name": "Multiple assignment", "description": "local a, b, c = 1, 2, 3", "examples": 1},
        ],
        "common_mistakes": [
            "Không dùng local -> tạo global variable",
            "Đặt tên biến không rõ nghĩa: x, temp, data",
            "Dùng biến trước khi khai báo",
        ],
        "real_world": "Lưu player health, game settings, counters",
        "estimated_time": "20-25 minutes",
        "mini_project": "Tạo hệ thống lưu thông tin player với biến"
    },
    {
        "n": 3,
        "title": "Data Types - Các kiểu dữ liệu",
        "phase": "Fundamentals",
        "keywords": ["number", "string", "boolean", "nil", "table", "typeof", "type"],
        "difficulty": "Beginner",
        "prerequisites": [2],
        "learning_objectives": [
            "Nhận biết 6 data types cơ bản trong Lua",
            "Sử dụng typeof() để check type",
            "Hiểu khi nào dùng type nào",
            "Chuyển đổi giữa các types",
        ],
        "subtopics": [
            {"name": "Numbers", "description": "Integers và decimals, không phân biệt", "examples": 2},
            {"name": "Strings", "description": "Text trong quotes", "examples": 2},
            {"name": "Booleans", "description": "true và false", "examples": 2},
            {"name": "nil", "description": "Giá trị 'không có gì'", "examples": 2},
            {"name": "Tables", "description": "Giới thiệu cơ bản về tables", "examples": 1},
            {"name": "typeof()", "description": "Check type của giá trị", "examples": 2},
            {"name": "Type conversion", "description": "tonumber(), tostring()", "examples": 2},
        ],
        "common_mistakes": [
            "Nhầm '5' (string) với 5 (number)",
            "Quên nil không phải 'nil' (string)",
            "Không check type trước khi thao tác",
        ],
        "real_world": "Player health (number), name (string), isAlive (boolean)",
        "estimated_time": "25-30 minutes",
        "mini_project": "Tạo player data table với đủ các types"
    },
    {
        "n": 4,
        "title": "Strings - Chuỗi ký tự nâng cao",
        "phase": "Fundamentals",
        "keywords": ["string", "..", "concat", "format", "interpolation", "length", "sub", "find"],
        "difficulty": "Beginner",
        "prerequisites": [3],
        "learning_objectives": [
            "Thành thạo tạo và thao tác strings",
            "Nối chuỗi với .. operator",
            "Sử dụng string methods",
            "String interpolation với backticks",
        ],
        "subtopics": [
            {"name": "Tạo strings", "description": "Single, double quotes, [[multiline]]", "examples": 2},
            {"name": "Concatenation", "description": "Nối chuỗi với ..", "examples": 2},
            {"name": "String length", "description": "#string hoặc string.len()", "examples": 1},
            {"name": "string.sub()", "description": "Cắt một phần của string", "examples": 2},
            {"name": "string.find()", "description": "Tìm vị trí substring", "examples": 2},
            {"name": "string.upper/lower", "description": "Chuyển hoa/thường", "examples": 1},
            {"name": "string.format()", "description": "Format string với placeholders", "examples": 2},
            {"name": "String interpolation", "description": "`Hello {name}`", "examples": 2},
        ],
        "common_mistakes": [
            "Nối number với string không convert: 'Score: ' .. 100",
            "Nhầm # với .len()",
            "Index string từ 1, không phải 0",
        ],
        "real_world": "Chat messages, UI text, formatted output",
        "estimated_time": "20-25 minutes",
        "mini_project": "Tạo hệ thống chat format với màu và prefixes"
    },
    {
        "n": 5,
        "title": "Math - Toán học trong Lua",
        "phase": "Fundamentals",
        "keywords": ["math", "random", "floor", "ceil", "abs", "clamp", "+", "-", "*", "/", "%", "^"],
        "difficulty": "Beginner",
        "prerequisites": [3],
        "learning_objectives": [
            "Sử dụng tất cả arithmetic operators",
            "Hiểu math library functions",
            "Random numbers cho game mechanics",
            "Clamp values trong range",
        ],
        "subtopics": [
            {"name": "Arithmetic operators", "description": "+, -, *, /, %, ^", "examples": 2},
            {"name": "Order of operations", "description": "PEMDAS trong Lua", "examples": 2},
            {"name": "math.floor/ceil", "description": "Làm tròn xuống/lên", "examples": 2},
            {"name": "math.abs", "description": "Giá trị tuyệt đối", "examples": 1},
            {"name": "math.random", "description": "Random numbers", "examples": 3},
            {"name": "math.clamp", "description": "Giới hạn giá trị trong range", "examples": 2},
            {"name": "math.min/max", "description": "Tìm min/max", "examples": 1},
        ],
        "common_mistakes": [
            "Chia cho 0",
            "Quên math.random() cần seed",
            "Không dùng clamp cho health/values",
        ],
        "real_world": "Damage calculations, random loot, health regen",
        "estimated_time": "20-25 minutes",
        "mini_project": "Tạo damage calculator với critical chance random"
    },
    {
        "n": 6,
        "title": "Booleans và Comparisons",
        "phase": "Fundamentals",
        "keywords": ["true", "false", "==", "~=", "<", ">", "<=", ">=", "and", "or", "not"],
        "difficulty": "Beginner",
        "prerequisites": [3],
        "learning_objectives": [
            "Hiểu true/false và truthy/falsy",
            "Sử dụng comparison operators",
            "Kết hợp conditions với and/or/not",
            "Short-circuit evaluation",
        ],
        "subtopics": [
            {"name": "true và false", "description": "Boolean values", "examples": 2},
            {"name": "Comparison operators", "description": "==, ~=, <, >, <=, >=", "examples": 3},
            {"name": "Logical AND", "description": "Cả hai phải true", "examples": 2},
            {"name": "Logical OR", "description": "Một trong hai true", "examples": 2},
            {"name": "Logical NOT", "description": "Đảo ngược boolean", "examples": 2},
            {"name": "Truthy/Falsy", "description": "nil và false là falsy", "examples": 2},
            {"name": "Short-circuit", "description": "and/or trả về giá trị", "examples": 2},
        ],
        "common_mistakes": [
            "Dùng = thay vì == để so sánh",
            "Dùng != thay vì ~=",
            "Không hiểu truthy/falsy",
        ],
        "real_world": "Check player conditions, game state logic",
        "estimated_time": "25-30 minutes",
        "mini_project": "Tạo permission system với multiple conditions"
    },
    {
        "n": 7,
        "title": "if/elseif/else - Điều kiện",
        "phase": "Fundamentals",
        "keywords": ["if", "then", "elseif", "else", "end", "conditional", "branch"],
        "difficulty": "Beginner",
        "prerequisites": [6],
        "learning_objectives": [
            "Viết if statements đúng cách",
            "Sử dụng elseif cho multiple conditions",
            "Nested if statements",
            "Guard clauses pattern",
        ],
        "subtopics": [
            {"name": "if-then-end", "description": "Cấu trúc cơ bản", "examples": 2},
            {"name": "if-else", "description": "Thêm alternative branch", "examples": 2},
            {"name": "elseif chains", "description": "Multiple conditions", "examples": 2},
            {"name": "Nested if", "description": "If trong if", "examples": 2},
        ...
        "common_mistakes": [
            "Quên 'then' sau condition",
            "Quên 'end'",
            "Dùng quá nhiều nested if (pyramid of doom)",
        ],
        "real_world": "Permission checks, level requirements, game state",
        "estimated_time": "25-30 minutes",
        "mini_project": "Tạo rank system dựa trên player level"
    },
    {
        "n": 8,
        "title": "Functions - Hàm cơ bản",
        "phase": "Fundamentals",
        "keywords": ["function", "end", "call", "invoke", "define", "declaration"],
        "difficulty": "Beginner",
        "prerequisites": [7],
        "learning_objectives": [
            "Hiểu function là gì và tại sao cần",
            "Định nghĩa và gọi functions",
            "DRY principle",
            "Local vs global functions",
        ],
        "subtopics": [
            {"name": "Function là gì?", "description": "Reusable code blocks", "examples": 2},
            {"name": "Định nghĩa function", "description": "local function name() end", "examples": 2},
            {"name": "Gọi function", "description": "functionName()", "examples": 2},
            {"name": "Anonymous functions", "description": "function() end không tên", "examples": 2},
        ...
        "common_mistakes": [
            "Gọi function trước khi định nghĩa",
            "Không dùng local cho functions",
            "Quên gọi function (chỉ định nghĩa)",
        ],
        "real_world": "Reusable game logic, event handlers",
        "estimated_time": "25-30 minutes",
        "mini_project": "Refactor repeated code thành functions"
    },
    {
        "n": 9,
        "title": "Functions - Parameters và Return",
        "phase": "Fundamentals",
        "keywords": ["parameter", "argument", "return", "multiple return", "default", "variadic"],
        "difficulty": "Intermediate",
        "prerequisites": [8],
        "learning_objectives": [
            "Truyền data vào function với parameters",
            "Trả về data với return",
            "Multiple return values",
            "Default parameter pattern",
        ],
        "subtopics": [
            {"name": "Parameters", "description": "Nhận input vào function", "examples": 2},
            {"name": "Arguments", "description": "Giá trị truyền khi gọi", "examples": 2},
            {"name": "Return statement", "description": "Trả về giá trị", "examples": 2},
            ...
            {"name": "Variadic (...)", "description": "Nhận số lượng args không giới hạn", "examples": 2},
        ],
        "common_mistakes": [
            "Không return gì (nil by default)",
            "Quên nhận multiple returns",
            "Thay đổi parameter không ảnh hưởng ngoài function",
        ],
        "real_world": "Damage calculation, utility functions",
        "estimated_time": "30-35 minutes",
        "mini_project": "Tạo các utility functions cho game"
    },
    {
        "n": 10,
        "title": "Tables - Arrays",
